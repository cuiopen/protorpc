...
class EchoServiceA_Stub;

class EchoServiceA : public ::google::protobuf::rpc::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline EchoServiceA() {};
 public:
  virtual ~EchoServiceA();
  
  typedef EchoServiceA_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(EchoServiceA);
};

class EchoServiceA_Stub : public EchoServiceA {
 public:
  EchoServiceA_Stub(::google::protobuf::rpc::Caller* client);
  EchoServiceA_Stub(::google::protobuf::rpc::Caller* client, bool client_ownership);
  ~EchoServiceA_Stub();
  
  // implements EchoServiceA ------------------------------------------
 ...
 private:
  ::google::protobuf::rpc::Caller* client_;
  bool owns_client_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(EchoServiceA_Stub);
};


// -------------------------------------------------------------------

class EchoServiceB_Stub;

class EchoServiceB : public ::google::protobuf::rpc::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline EchoServiceB() {};
 public:
  virtual ~EchoServiceB();
  
  typedef EchoServiceB_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(EchoServiceB);
};

class EchoServiceB_Stub : public EchoServiceB {
 public:
  EchoServiceB_Stub(::google::protobuf::rpc::Caller* client);
  EchoServiceB_Stub(::google::protobuf::rpc::Caller* client, bool client_ownership);
  ~EchoServiceB_Stub();
  
  // implements EchoServiceB ------------------------------------------
 ...
 private:
  ::google::protobuf::rpc::Caller* client_;
  bool owns_client_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(EchoServiceB_Stub);
};
