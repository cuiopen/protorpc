...
class MyRequest : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:service.MyRequest)
 private:
...
inline void MyRequest::set_has_msg() {
  _has_bits_[0] |= 0x00000001u;
}
inline void MyRequest::clear_has_msg() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void MyRequest::set_msg(const ::std::string& value) {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::kEmptyString) {
    msg_ = new ::std::string;
  }
...
inline void MyRequest::set_msg(const char* value) {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::kEmptyString) {
    msg_ = new ::std::string;
  }
...
inline void MyRequest::set_msg(const char* value, size_t size) {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::kEmptyString) {
    msg_ = new ::std::string;
  }
