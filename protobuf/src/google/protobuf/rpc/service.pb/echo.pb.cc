...
const ::google::protobuf::ServiceDescriptor* EchoServiceA_descriptor_ = NULL;
const ::google::protobuf::ServiceDescriptor* EchoServiceB_descriptor_ = NULL;
...
void protobuf_AssignDesc_echo_2eproto() {
  ...
  EchoServiceA_descriptor_ = file->service(1);
  EchoServiceB_descriptor_ = file->service(2);
}
...
void protobuf_AddDesc_echo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "est\032\025.service.EchoResponse2C\n\014EchoServic"
    "eA\0223\n\004echo\022\024.service.EchoRequest\032\025.servi"
    "ce.EchoResponse2C\n\014EchoServiceB\0223\n\004echo\022"
    "\024.service.EchoRequest\032\025.service.EchoResp"
    "onseB\t\200\001\001\210\001\001\220\001\001", 295);
...
EchoServiceA::~EchoServiceA() {}

const ::google::protobuf::ServiceDescriptor* EchoServiceA::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return EchoServiceA_descriptor_;
}

const ::google::protobuf::ServiceDescriptor* EchoServiceA::GetDescriptor() {
  protobuf_AssignDescriptorsOnce();
  return EchoServiceA_descriptor_;
}

const ::google::protobuf::rpc::Error EchoServiceA::echo(
  const ::service::EchoRequest*,
  ::service::EchoResponse*) {
  return ::google::protobuf::rpc::Error("Method EchoServiceA::echo() not implemented.");
}

const ::google::protobuf::rpc::Error EchoServiceA::CallMethod(
  const ::google::protobuf::MethodDescriptor* method,
  const ::google::protobuf::Message* request,
  ::google::protobuf::Message* response) {
  GOOGLE_DCHECK_EQ(method->service(), EchoServiceA_descriptor_);
  switch(method->index()) {
    case 0:
      return echo(
        ::google::protobuf::down_cast<const ::service::EchoRequest*>(request),
...
const ::google::protobuf::Message& EchoServiceA::GetRequestPrototype(
    const ::google::protobuf::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
const ::google::protobuf::Message& EchoServiceA::GetResponsePrototype(
    const ::google::protobuf::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
EchoServiceA_Stub::EchoServiceA_Stub(::google::protobuf::rpc::Caller* client)
  : client_(client), owns_client_(false) {}
EchoServiceA_Stub::EchoServiceA_Stub(
    ::google::protobuf::rpc::Caller* client, bool client_ownership)
  : client_(client),
    owns_client_(client_ownership) {}
EchoServiceA_Stub::~EchoServiceA_Stub() {
...
const ::google::protobuf::rpc::Error EchoServiceA_Stub::echo(
  const ::service::EchoRequest* request,
  ::service::EchoResponse* response) {
  return client_->CallMethod(descriptor()->method(0), request, response);
}
...
EchoServiceB::~EchoServiceB() {}

const ::google::protobuf::ServiceDescriptor* EchoServiceB::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return EchoServiceB_descriptor_;
}

const ::google::protobuf::ServiceDescriptor* EchoServiceB::GetDescriptor() {
  protobuf_AssignDescriptorsOnce();
  return EchoServiceB_descriptor_;
}

const ::google::protobuf::rpc::Error EchoServiceB::echo(
  const ::service::EchoRequest*,
  ::service::EchoResponse*) {
  return ::google::protobuf::rpc::Error("Method EchoServiceB::echo() not implemented.");
}

const ::google::protobuf::rpc::Error EchoServiceB::CallMethod(
  const ::google::protobuf::MethodDescriptor* method,
  const ::google::protobuf::Message* request,
  ::google::protobuf::Message* response) {
  GOOGLE_DCHECK_EQ(method->service(), EchoServiceB_descriptor_);
  switch(method->index()) {
    case 0:
      return echo(
        ::google::protobuf::down_cast<const ::service::EchoRequest*>(request),
...
const ::google::protobuf::Message& EchoServiceB::GetRequestPrototype(
    const ::google::protobuf::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
const ::google::protobuf::Message& EchoServiceB::GetResponsePrototype(
    const ::google::protobuf::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
EchoServiceB_Stub::EchoServiceB_Stub(::google::protobuf::rpc::Caller* client)
  : client_(client), owns_client_(false) {}
EchoServiceB_Stub::EchoServiceB_Stub(
    ::google::protobuf::rpc::Caller* client, bool client_ownership)
  : client_(client),
    owns_client_(client_ownership) {}
EchoServiceB_Stub::~EchoServiceB_Stub() {
...
const ::google::protobuf::rpc::Error EchoServiceB_Stub::echo(
  const ::service::EchoRequest* request,
  ::service::EchoResponse* response) {
  return client_->CallMethod(descriptor()->method(0), request, response);
}
