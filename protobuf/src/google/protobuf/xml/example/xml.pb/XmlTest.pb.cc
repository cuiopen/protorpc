...
bool PbMessage::ParseFromXmlString(const string& data) {
...
bool PbMessage::ParsePartialFromXmlString(const string& data) {
  ::google::protobuf::xml::XmlMessage stub(*const_cast<PbMessage*>(this));
  if(!stub.ParseFromString(data)) {
...
bool PbMessage::SerializeToXmlString(string* output) const {
  output->clear();
  if (!this->IsInitialized()) {
    GOOGLE_LOG(WARNING)
...
bool PbMessage::SerializePartialToXmlString(string* output) const {
  output->clear();
...
bool PbXmlTest::ParseFromXmlString(const string& data) {
...
bool PbXmlTest::ParsePartialFromXmlString(const string& data) {
  ::google::protobuf::xml::XmlMessage stub(*const_cast<PbXmlTest*>(this));
  if(!stub.ParseFromString(data)) {
    GOOGLE_LOG(WARNING) << "ParsePartialFromXmlString failed: " << stub.GetErrorText();
    return false;
...
bool PbXmlTest::SerializeToXmlString(string* output) const {
  output->clear();
  if (!this->IsInitialized()) {
    GOOGLE_LOG(WARNING)
      << "SerializeToXmlString failed: missing required fields: "
...
bool PbXmlTest::SerializePartialToXmlString(string* output) const {
  output->clear();
